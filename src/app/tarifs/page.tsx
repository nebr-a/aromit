...
const faqs = [
  ...
  { q: "Vous garantissez vraiment de rappeler en moins de 2h ?", a: 'Oui, c\'est écrit dans le contrat : on vous rappelle en moins de 2 heures (en heures ouvrables) — 1 heure sur le forfait DSI Externalisé. Si on rate cet engagement une seule fois dans le mois, le mois est offert.' },
...
const guarantees = [
  ...
  {
    icon: Clock,
    title: 'On vous rappelle en moins de 2h',
    text: "Garanti par contrat : 2h ouvrables (1h sur le DSI Externalisé). Si on rate, le mois est offert.",
  },
  {
    icon: AlertCircle,
    ...
    <>
      ...
      <main>
        ...
        <QuickAnswer
          ...
          points={[
            'Tous les prix sont publics — rare dans le secteur IT en Suisse romande',
            'Garantie 90 jours : pas content, on rembourse intégralement',
            "On vous rappelle en moins de 2h, garanti par contrat. Sinon le mois est offert",
